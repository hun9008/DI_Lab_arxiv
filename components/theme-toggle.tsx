  ...
  return (
    <button
      ...
      className={cn(
        ...
        "border-border/80 bg-gradient-to-r from-slate-100 via-white to-slate-100 shadow-none",
        "hover:border-primary/40 hover:shadow-none",
        "dark:border-white/10 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 dark:shadow-none dark:hover:shadow-none"
      )}
    >
      <span
        className={cn(
          "absolute top-1 h-7 w-7 rounded-full transition-all duration-300",
          "bg-gradient-to-b from-white to-slate-200 shadow-none",
          "dark:from-slate-700 dark:to-slate-900 dark:shadow-none",
